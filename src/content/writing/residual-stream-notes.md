...
$$
L_{in_i}^{t_n} = L_{out_{i-1}}^{t_n}
\qquad \text{input to layer \(i\) for token \(t_n\)}
$$
$$
...
<!-- TODO: Export Excalidraw frame HPQt7SHP - Multihead attention diagram -->
...
![per head vs archi](/images/per%20head%20vs%20archi.png)
...
<!-- TODO: Export Excalidraw frame VLEXJQzl - Architecture diagram -->

### when does it happen?
#### Step A: Attention
<!-- TODO: Export Excalidraw frame LqfdPiNm - Attention step diagram -->
for eg, 
...
<!-- TODO: Export Excalidraw frame qBorIvFd - Distribution change diagram -->
...
\text{New Score}
= (x + v)\cdot e_t
= \underbrace{x \cdot e_t}_{\text{Old Score}}
+ \underbrace{v \cdot e_t}_{\text{Change}}
$$
...
![probability curve](/images/Pasted%20image%2020260124232612.png)
...
![log probability curve](/images/Pasted%20image%2020260124234633.png)
...
- there's a roughly linear relationship between contribution scores
  ![contribution scores linear relation](/images/Pasted%20image%2020260125015316.png)$\text{x axis}: C(v_{1})+C(v_{2})+\dots \text{y axis : }C(v_{1}+v_{2}+v_{3}+\dots)$
...
![layer norm linear relation](/images/Pasted%20image%2020260125024827.png)
...
![FFN contribution screenshot](/images/Screenshot%202026-01-25%20at%204.09.18%20PM.png)
